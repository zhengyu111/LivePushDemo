...
import com.zhengyu.LivePushDemo.R;
import com.zhengyu.LivePushDemo.data.CreateStreamData;
import com.zhengyu.LivePushDemo.data.LetvStreamData;
import com.zhengyu.LivePushDemo.data.StreamData;
...
public class MainActivity extends Activity {
    ...
    private static final String DEFAULT_PUSHSTREAM = "rtmp://8070.mpush.live.lecloud.com/live/demo";
    // 乐视云直播推流用户userID,用户可以在官网用户中心拿到
    private static final String DEFAULT_LETV_USERID = "";
    //乐视云直播推流用户私钥，用户可以在官网用户中心拿到
    private static final String DEFAULT_LETV_APPKEY = "";
    //乐视云直播推流ID，用户开通云直播功能，可以在创建活动后拿到
    private static final String DEFAULT_LETV_STREAMID = "";

    private String default_streamid = "";
    ...
    private void addNoStreamView(View v) {
        ...
        if (createStreamData.getDomainName() != null) {
            ...
            etDomainName.setText(DEFAULT_DOMAINNAME);
        }
